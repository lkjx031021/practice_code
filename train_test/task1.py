...
# checkpoint = "D:/doc/my_project/lianxi/train_test/model/bert-base-chinese-tokenizer"
checkpoint = "train_test/model/bert-base-chinese-tokenizer"
...
train_data = PeopleDaily('train_test/china-people-daily-ner-corpus/example.train')
valid_data = PeopleDaily('train_test/china-people-daily-ner-corpus/example.dev')
test_data = PeopleDaily('train_test/china-people-daily-ner-corpus/example.test')
...
checkpoint = "train_test/model/bert-base-chinese"
